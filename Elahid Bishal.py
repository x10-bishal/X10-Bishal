...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/X10-Bishal/Elahid/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/X10-Bishal/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/X10-Bishal/Elahid/main/ali.py > ali.py')
...
def Herry():
    ...
    if Herryx =='5':
        exit()
    if Herryx =='3':
        os.system('xdg-open https://github.com/X10-Bishal?tab=projects ')
    if Herryx =='4':
        os.system('xdg-open https://www.facebook.com/X10-Bishal');Herry()
    if Herryx =='2':
        bangla()
    else:
